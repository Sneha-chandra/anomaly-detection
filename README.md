...
<body>
  ...
  <ul>
    ...
    <li><a href="#maintainer">About the Project Maintainer</a></li>
  </ul>
  ...
  <pre><code>git clone https://github.com/sneha-chandra/anomaly-detection.git
...
with open("regressor_model.pkl", 'wb') as file:
  ...
  <h2 id="maintainer">About the Project Maintainer</h2>
  <p>
    This project is currently maintained by Sneha Chandra, a Digital Twin Intern with over 5 years of professional experience. 
    Sneha is dedicated to ensuring the project's continued development and functionality.
    For questions or contributions, please reach out via:
    <ul>
      <li>GitHub: <a href="https://github.com/sneha-chandra">https://github.com/sneha-chandra</a></li>
      <li>LinkedIn: <a href="https://www.linkedin.com/in/sneha-chandra">https://www.linkedin.com/in/sneha-chandra</a></li>
      <li>Email: <a href="mailto:snehachandra042@gmail.com">snehachandra042@gmail.com</a></li>
    </ul>
  </p>
</body>
</html>